...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='blocked_class', through='accounts.BlockedRelationships', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='user',
            name='follower_class',
            field=models.ManyToManyField(related_name='followee_class', through='accounts.FollowingRelationships', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
